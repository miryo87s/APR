...
- Double robustness means that $\tau_{ob}$ is consistent of ATE if either $\mathbb{E}[D_i|X_i]$ or $\mathbb{E}[Y_i(d)|X_i]$ is correctly specified
...
- **Use IPW**
  ...
  - AIPW can provide more robustness

<br>

- If one uses OLS, change the interpretation of the coefficient
